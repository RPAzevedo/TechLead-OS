...
| Project              | P1   | delivery/projects/                 | Something the team delivers, and the components that have to come together to form it. Fields: `owner`, `stage`, `next_checkpoint`, `resource`. Pointers: `slack`, `jira`, `confluence`, `rfc`.                                                                                                          | 30 d             | <span class="tier human">human-reviewed</span>      | Goal · Status · Components & owners · Next · Risks · Decisions                                   |
| Initiative           | P1   | delivery/initiatives/              | A cross-functional effort, or a company moving part you must track. Fields: `owner`, `stage`, `next_checkpoint`. Pointers: `slack`, `jira`, `confluence`, `rfc`.                                                                                                                                         | 30 d             | <span class="tier human">human-reviewed</span>      | Problem statement · Status · Timeline · Stakeholders · Dependencies · My stance · Open questions |
...
| Objective            | P1   | delivery/objectives/               | A team OKR for the quarter; sprint goals link back to it.                                                                                                                                                                                                | 90 d             | <span class="tier human">human-reviewed</span>      | Objective · Key results · Sprint goals · Status                                                  |
