...
- [RFC: Media pipeline v2](../design/rfcs/example-media-pipeline-v2.md) — review due back by {{DATE+7}}

# Systems
- [Asset search](../systems/example-asset-search.md): 1 operational standard unticked (alert budget)
